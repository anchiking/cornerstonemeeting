    ...
    objects: {
        ...
        navigator: {
            children: {
                ...
                //[20120821][chisu]add mediamanager
                menumanager:{
                	path: 'srt/plugin/menumanager'
                },
                //[20121118][chisu]add nfc
                nfc:{
                	path: 'srt/plugin/nfc'
                },
...
//[20121203][chisu]add menumanager
//file: lib/common/plugin/menumanager.js
sktdefine("srt/plugin/menumanager", function(sktrequire, exports, module) {
	...
	var menumanager = {
			...
			addMenu: function(action, menuCallback) {
				...
				// successCallback required
					...
					throw "first argument must be string Type.";
				}

				exec(menuCallback, null, "MenuManager", "addMenu", [action]);
			},
			
			removeMenu: function(action) {
				if(action != null && typeof action != "string"){
					throw "first argument must be string Type.";
				}

				exec(null, null, "MenuManager", "removeMenu", [action]);
			},
			
			removeAll: function() {

				exec(null, null, "MenuManager", "removeAll", []);
			}
...
//file: lib/common/plugin/NFC.js
sktdefine("srt/plugin/Nfc", function(sktrequire, exports, module) {
	module.exports = {
			TYPE_URL:   		 0,
			TYPE_LOCATION:  	 1,
			TYPE_MY_NUMBER:      2,
			TYPE_CONTACT_NUMBER: 3,
			TYPE_MESSAGE:        4,
			TYPE_IMAGE:          5
	};
});
...
sktdefine("srt/plugin/nfc", function(sktrequire, exports, module) {
	...
	var nfc = {
			...
			maketaginfo: function(successCallback, errorCallback, type , message) {
				// successCallback required
				if (typeof successCallback !== "function" ) {
					throw "maketaginfo must be called with at least a success callback function as first parameter.";
				}  
				// successCallback required
				else if (successCallback === null ) {
					throw "maketaginfo must be called with at least a success callback function as first parameter.";
				...
				else if(type != null && typeof type != "number"){
					throw "3rd argument must be number Type.";
				}

				exec(successCallback, errorCallback, "Nfc", "maketaginfo", [type,message]);
			},

			isNFCSupport: function() {
				var isNFCSupport = exec(null, null, "Nfc", "isNFCSupport", []);
				return isNFCSupport;
			},
			
			setNFCUse: function(use){
				 if(use != null && typeof use != "boolean"){
						throw "1st argument must be boolean Type.";
					}
...
//			},
			...
			setReadTagCallback: function(successCallback) {
				// successCallback required
				if (typeof successCallback !== "function" ) {
					throw "setReadTagCallback must be called with at least a success callback function as first parameter.";
				}  
				// successCallback required
				else if (successCallback === null ) {
					throw "setReadTagCallback must be called with at least a success callback function as first parameter.";
				...
				exec(successCallback, null, "Nfc", "setReadTagCallback", []);
			}
...
sktdefine("srt/plugin/deviceinteraction", function(sktrequire, exports, module) {
	...
	var deviceinteraction = {
		...
		setWallpaper: function(successCallback, errorCallback, path) {
			 ...
			 * 
			 * @param {Function} successCallback The function to call.
			 * @param {Function} errorCallback The function to call.
			 */
			playRingtone: function(successCallback, errorCallback){
				// successCallback required
				if (typeof successCallback !== "function" ) {
					throw "playRingtone must be called with at least a success callback function as first parameter.";
				}  
				// successCallback required
				else if (successCallback === null ) {
					throw "playRingtone must be called with at least a success callback function as first parameter.";
				...
				return exec(successCallback, errorCallback, "DeviceInteraction", "playRingtone", []);
			},
			/**
